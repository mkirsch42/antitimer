...
public enum IniTweak {
    ...
    NO_CAP("Remove FPS Cap (Disallowed in 100% and Pink Cubes)",
	    new IniOption[]{
		    new IniOption("UDKInput.ini", "Engine.PlayerInput", "Bindings", "(Name=\"LeftAlt\",Command=\"SetFps 60 | onrelease SetFps 999\",Control=False,Shift=False,Alt=False,bIgnoreCtrl=False,bIgnoreShift=False,bIgnoreAlt=False)"),
		    new IniOption("UDKEngine.ini", "Engine.Engine", "MinSmoothedFrameRate", "60"),
		    new IniOption("UDKEngine.ini", "Engine.Engine", "MinSmoothedFrameRate", "999"),
		    new IniOption("UDKEngine.ini", "SystemSettings", "UseVsync", "False")
	    },
	    new IniOption[]{
		    new IniOption("UDKEngine.ini", "Engine.Engine", "MinSmoothedFrameRate", "22"),
		    new IniOption("UDKEngine.ini", "Engine.Engine", "MinSmoothedFrameRate", "62"),
